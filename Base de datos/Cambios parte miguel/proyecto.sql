...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2017 a las 13:13:44
...
CREATE TABLE `peliculas` (
  ...
  `Titulo` varchar(40) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Genero` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Director` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Sinopsis` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
(21, 'Documental 1', 'Documental', 'sdfg', 'sdfg', '2017-05-21');
...
(1, 'ninguno', 12, 12, 'sdfa', 'dsf'),
(2, 'ninguno', 12, 12, 'sdfa', 'dsf');
...
--
ALTER TABLE `salas`
  MODIFY `IDSalas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
